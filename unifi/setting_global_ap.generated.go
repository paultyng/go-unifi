...
func (dst *SettingGlobalAp) UnmarshalJSON(b []byte) error {
	...
	dst.NaChannelSize = aux.NaChannelSize.Value()
	dst.NaTxPower = aux.NaTxPower.Value()
	dst.NgChannelSize = aux.NgChannelSize.Value()
	dst.NgTxPower = aux.NgTxPower.Value()
	dst.SixEChannelSize = aux.SixEChannelSize.Value()
	dst.SixETxPower = aux.SixETxPower.Value()
