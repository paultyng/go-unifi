...
func (dst *SettingUsg) UnmarshalJSON(b []byte) error {
	...
	dst.ArpCacheBaseReachable = aux.ArpCacheBaseReachable.Value()
	dst.DHCPRelayHopCount = aux.DHCPRelayHopCount.Value()
	dst.DHCPRelayMaxSize = aux.DHCPRelayMaxSize.Value()
	dst.DHCPRelayPort = aux.DHCPRelayPort.Value()
	dst.ICMPTimeout = aux.ICMPTimeout.Value()
	dst.MssClampMss = aux.MssClampMss.Value()
	dst.OtherTimeout = aux.OtherTimeout.Value()
	dst.TCPCloseTimeout = aux.TCPCloseTimeout.Value()
	dst.TCPCloseWaitTimeout = aux.TCPCloseWaitTimeout.Value()
	dst.TCPEstablishedTimeout = aux.TCPEstablishedTimeout.Value()
	dst.TCPFinWaitTimeout = aux.TCPFinWaitTimeout.Value()
	dst.TCPLastAckTimeout = aux.TCPLastAckTimeout.Value()
	dst.TCPSynRecvTimeout = aux.TCPSynRecvTimeout.Value()
	dst.TCPSynSentTimeout = aux.TCPSynSentTimeout.Value()
	dst.TCPTimeWaitTimeout = aux.TCPTimeWaitTimeout.Value()
	dst.UDPOtherTimeout = aux.UDPOtherTimeout.Value()
	dst.UDPStreamTimeout = aux.UDPStreamTimeout.Value()
