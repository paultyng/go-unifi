...
func (dst *Device) UnmarshalJSON(b []byte) error {
	...
	dst.GatewayVrrpPriority = aux.GatewayVrrpPriority.Value()
	dst.LcmBrightness = aux.LcmBrightness.Value()
	dst.LcmIDleTimeout = aux.LcmIDleTimeout.Value()
	dst.LedOverrideColorBrightness = aux.LedOverrideColorBrightness.Value()
	dst.LteExtAnt = aux.LteExtAnt.Value()
	dst.LteHardLimit = aux.LteHardLimit.Value()
	dst.LtePoe = aux.LtePoe.Value()
	dst.LteSimPin = aux.LteSimPin.Value()
	dst.LteSoftLimit = aux.LteSoftLimit.Value()
	dst.PowerSourceCtrlBudget = aux.PowerSourceCtrlBudget.Value()
	dst.StpPriority = aux.StpPriority.Value()
	dst.Volume = aux.Volume.Value()
...
func (dst *DevicePortOverrides) UnmarshalJSON(b []byte) error {
	...
	dst.AggregateNumPorts = aux.AggregateNumPorts.Value()
	dst.Dot1XIDleTimeout = aux.Dot1XIDleTimeout.Value()
	dst.EgressRateLimitKbps = aux.EgressRateLimitKbps.Value()
	dst.MirrorPortIDX = aux.MirrorPortIDX.Value()
	dst.PortIDX = aux.PortIDX.Value()
	dst.PriorityQueue1Level = aux.PriorityQueue1Level.Value()
	dst.PriorityQueue2Level = aux.PriorityQueue2Level.Value()
	dst.PriorityQueue3Level = aux.PriorityQueue3Level.Value()
	dst.PriorityQueue4Level = aux.PriorityQueue4Level.Value()
	dst.Speed = aux.Speed.Value()
	dst.StormctrlBroadcastastLevel = aux.StormctrlBroadcastastLevel.Value()
	dst.StormctrlBroadcastastRate = aux.StormctrlBroadcastastRate.Value()
	dst.StormctrlMcastLevel = aux.StormctrlMcastLevel.Value()
	dst.StormctrlMcastRate = aux.StormctrlMcastRate.Value()
	dst.StormctrlUcastLevel = aux.StormctrlUcastLevel.Value()
	dst.StormctrlUcastRate = aux.StormctrlUcastRate.Value()
...
func (dst *DeviceQOSMarking) UnmarshalJSON(b []byte) error {
	...
	dst.CosCode = aux.CosCode.Value()
	dst.DscpCode = aux.DscpCode.Value()
	dst.IPPrecedenceCode = aux.IPPrecedenceCode.Value()
	dst.Queue = aux.Queue.Value()
...
func (dst *DeviceQOSMatching) UnmarshalJSON(b []byte) error {
	...
	dst.CosCode = aux.CosCode.Value()
	dst.DscpCode = aux.DscpCode.Value()
	dst.DstPort = aux.DstPort.Value()
	dst.IPPrecedenceCode = aux.IPPrecedenceCode.Value()
	dst.SrcPort = aux.SrcPort.Value()
...
func (dst *DeviceRadioTable) UnmarshalJSON(b []byte) error {
	...
	dst.AntennaGain = aux.AntennaGain.Value()
	dst.AntennaID = aux.AntennaID.Value()
	dst.BackupChannel = aux.BackupChannel.Value()
	dst.Channel = aux.Channel.Value()
	dst.Ht = aux.Ht.Value()
	dst.Maxsta = aux.Maxsta.Value()
	dst.MinRssi = aux.MinRssi.Value()
	dst.SensLevel = aux.SensLevel.Value()
	dst.TxPower = aux.TxPower.Value()
