...
func (dst *SettingSuperMgmt) UnmarshalJSON(b []byte) error {
	...
	dst.AutobackupDays = aux.AutobackupDays.Value()
	dst.AutobackupMaxFiles = aux.AutobackupMaxFiles.Value()
	dst.DataRetentionTimeInHoursFor5MinutesScale = aux.DataRetentionTimeInHoursFor5MinutesScale.Value()
	dst.DataRetentionTimeInHoursForDailyScale = aux.DataRetentionTimeInHoursForDailyScale.Value()
	dst.DataRetentionTimeInHoursForHourlyScale = aux.DataRetentionTimeInHoursForHourlyScale.Value()
	dst.DataRetentionTimeInHoursForMonthlyScale = aux.DataRetentionTimeInHoursForMonthlyScale.Value()
	dst.DataRetentionTimeInHoursForOthers = aux.DataRetentionTimeInHoursForOthers.Value()
	dst.MinimumUsableHdSpace = aux.MinimumUsableHdSpace.Value()
	dst.MinimumUsableSdSpace = aux.MinimumUsableSdSpace.Value()
