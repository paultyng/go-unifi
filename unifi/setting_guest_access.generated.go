...
func (dst *SettingGuestAccess) UnmarshalJSON(b []byte) error {
	...
	dst.ExpireNumber = aux.ExpireNumber.Value()
	dst.ExpireUnit = aux.ExpireUnit.Value()
	dst.PortalCustomizedBoxOpacity = aux.PortalCustomizedBoxOpacity.Value()
	dst.PortalCustomizedBoxRADIUS = aux.PortalCustomizedBoxRADIUS.Value()
	dst.PortalCustomizedLogoSize = aux.PortalCustomizedLogoSize.Value()
	dst.RADIUSDisconnectPort = aux.RADIUSDisconnectPort.Value()
